...
from search_service.database_handling.query_with_graphql import graphql_query, query_language_of_issue_by_uid, \
    query_all_uids, query_every_datas_from_active_issue
from search_service.elastic.elastic_search_helper import query_search, setting_string
...
# results = get_strings_for_suggestion_with_synonyms(es, 4, "selber", True)
# pretty_print(results)
# print(graphql_query(query_language_of_issue_by_uid(2)))
